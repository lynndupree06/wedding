...
Rails.application.config.assets.precompile += %w( app-directives.js )

Rails.application.config.assets.precompile += %w( Rochester-Regular.ttf )
Rails.application.config.assets.precompile += %w( MonsieurLaDoulaise-Regular.ttf )
Rails.application.config.assets.precompile += %w( Italianno-Regular.ttf )
Rails.application.config.assets.precompile += %w( LoversQuarrel-Regular.ttf )
