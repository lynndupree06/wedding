...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { inner_envelop: @party.inner_envelop, name: @party.name, outer_envelop: @party.outer_envelop }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { inner_envelop: @party.inner_envelop, name: @party.name, outer_envelop: @party.outer_envelop }
    assert_redirected_to party_path(assigns(:party))
  end
